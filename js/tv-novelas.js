const preguntas = [
    {
        pregunta: "¿De que serie son los personajes Chandler, Phoebe, Monica, Joey y Ross?",
        respuestas: ["Friends", "Elite", "Stranger", "The Crown"],
        correcta: 0
    },
    {
    ...
    {
        pregunta: "¿Cual es la profesion del personaje principal de la serie Braking Bat?",
